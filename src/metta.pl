...
( member(mork, Argv) -> ensure_loaded([memo_hooks, parser, translator, specializer, filereader, '../mork_ffi/morkspaces', spaces])
; ensure_loaded([memo_hooks, parser, translator, specializer, filereader, spaces])).
