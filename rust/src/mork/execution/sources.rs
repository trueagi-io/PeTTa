...
impl Source for BTMSource {
        ...
        'path: 'trie,
    {
        ...
        // prefix: '[2] BTM'
        static PREFIX: [u8; 5] =
            [item_byte(Tag::Arity(2)), item_byte(Tag::SymbolSize(3)), b'B', b'T', b'M'];
        let Resource::BTM(rz) = it.next().unwrap() else { unreachable!() };
...
impl Source for ACTSource {
        ...
        'path: 'trie,
    {
        ...
        static CONSTANT_PREFIX: [u8; 5] =
            [item_byte(Tag::Arity(3)), item_byte(Tag::SymbolSize(3)), b'A', b'C', b'T'];
...
impl Source for Z3Source {
        ...
        'path: 'trie,
    {
        ...
        static CONSTANT_PREFIX: [u8; 4] =
            [item_byte(Tag::Arity(3)), item_byte(Tag::SymbolSize(2)), b'z', b'3'];
    ...
    fn policy(
        ...
        if c == 0 {
            if cmp == 0 {
                ...
                e.shift(
                    e.newvars() as _,
                    &mut super::super::expr::ExprZipper::new(Expr { ptr: qv.as_mut_ptr() }),
                );
...
impl Source for CmpSource {
        ...
        'path: 'trie,
    {
        static EQ_PREFIX: [u8; 4] =
            [item_byte(Tag::Arity(3)), item_byte(Tag::SymbolSize(2)), b'=', b'='];
